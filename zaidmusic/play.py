...
def updated_stats(chat, queue, vol=100):
    if chat.id in callsmusic.pytgcalls.active_calls:
        ...
        if len(que) > 0:
            ...
            stats += "🎵 ꜱᴏɴɢ ᴘʟᴀʏᴇᴅ: `{}`\n".format(len(que))
            stats += "💡 ɴᴏᴡ ᴘʟᴀʏɪɴɢ: **{}**\n".format(queue[0][0])
            stats += "🎧 𝐒ᴜᴢᴜɴᴇ ᴜꜱᴇʀ ʙʏ: {}".format(queue[0][1].mention)
    else:
        stats = None
    return stats
...
async def ytplay(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                if message.chat.title.startswith("Channel Music: "):
                    await lel.edit(
                        f"💡 **ᴘʟᴇᴀꜱᴇ ᴀᴅᴅ 𝐒ᴜᴢᴜɴᴇ 𝐀ssɪssᴛᴀɴᴛ ʙʏ ᴄᴏᴍᴍᴀɴᴅ /userbotjoin**",
                    )
                try:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id,
                        "𝐉𝐨𝐢𝐧𝐞𝐝 𝐓𝐡𝐢𝐬 𝐆𝐫𝐨𝐮𝐩 𝐓𝐨 𝐒𝐞𝐫𝐯𝐞 𝐘𝐨𝐮 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐌𝐮𝐬𝐢𝐜 😁",
                    )
                    await lel.edit(
                        f"✅ **𝐌𝐮𝐬𝐢𝐜 𝐀𝐬𝐬𝐢𝐬𝐬𝐭𝐚𝐧𝐭 𝐉𝐨𝐢𝐧𝐞𝐝 𝐓𝐡𝐞 𝐆𝐫𝐨𝐮𝐩 𝐍𝐨𝐰 𝐋𝐞𝐭𝐬 𝐑𝐨𝐜𝐤 𝐎𝐧 𝐕𝐨𝐢𝐜𝐞 𝐂𝐡𝐚𝐭 🥳.**",
                    )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton("ꜱᴜᴘᴘᴏʀᴛ ⚡", url=f"https://t.me/Suzune_Support"),
            ],
        ]
    )
    message.from_user.first_name
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"☑️ **ꜱᴏɴɢ ᴀᴅᴅᴇᴅ ᴛᴏ Qᴜᴇᴜᴇ »** `{position}`\n\n🏷 **ɴᴀᴍᴇ:** [{title[:80]}]({url})\n⏱ **ᴅᴜʀᴀᴛɪᴏɴ:** `{duration}`\n🎧 **𝐒ᴜᴢᴜɴᴇ ᴜꜱᴇʀ ʙʏ:** {message.from_user.mention}",
        ...
        await message.reply_photo(
            ...
            + f"🎧 **𝐒ᴜᴢᴜɴᴇ ᴜꜱᴇʀ ʙʏ:** {message.from_user.mention}",
            reply_markup=keyboard,
        )
        os.remove("final.png")
